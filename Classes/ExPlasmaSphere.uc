//=============================================================================
// Nelsona:
// ExPlasmaSphere. Ripped and modified for some high rated A.I. but a bit retarded.
// These projectiles maybe are proving the AIRating showing something more true.
// Have fun, ladies !
//=============================================================================
class ExPlasmaSphere extends Projectile;
...
simulated function Timer()
{
	if ( Level.bDropDetail )
		LightType = LT_None;
	if ( (Physics == PHYS_None) && (LifeSpan > 0.8) )
		LifeSpan = 0.8;
}
